...
if (!empty($_POST)):
    ...
    if($_POST['password'] == $_POST['confirmPassword']):
        ...
        $_SESSION['messages']['success'][] = 'Félicitation, vous êtes inscrit !';
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <input type="text" name="nickname" id="nickname" class="form-control" autocomplete="current-password">
                                ...
                                <label for="inputPassword" class="mt-3">Confirmer votre mot de passe</label>
                                <input type="password" name="confirmPassword" id="inputPassword" class="form-control" autocomplete="current-password">
                                

                                <button class="btn mb-2 mt-3 mb-md-0 btn-outline-success btn-block" type="submit">
                                    S'inscrire
                                </button>
                            </div>
                        </div>
